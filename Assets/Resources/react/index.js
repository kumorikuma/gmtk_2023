...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".black-bar{position:fixed;bottom:0;left:0;right:0;height:250px;background:linear-gradient(90deg, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.8) 20%, rgba(0, 0, 0, 0.8) 80%, rgba(0, 0, 0, 0.5));display:flex;flex-direction:row;padding:24px;padding-left:20%}.content{display:flex;flex-direction:column;align-items:flex-start;justify-content:flex-start;text-align:left;font-family:sans-serif}.title{padding-left:48px;color:#fff;font-size:24px}.gradient-rule{height:1px;width:400px;background-image:linear-gradient(90deg, transparent, rgba(255, 255, 255, 0.8), transparent);margin:16px 0}.message{padding:24px;padding-left:64px;color:#fff;font-size:18px}.spacer{flex-grow:1}.main-menu{display:flex;flex-direction:column;height:100%}.main-menu .rule{height:1px;align-self:stretch;background-image:linear-gradient(90deg, transparent, rgba(255, 255, 255, 0.8), transparent);margin:0px 0}.main-menu .top-bar{height:100px;background-color:rgba(0,0,0,.8)}.main-menu .content{flex-grow:1}.main-menu .bottom-bar{height:75px;background-color:rgba(0,0,0,.8)}", ""]);
// Exports
...
;// CONCATENATED MODULE: ./src/menu.tsx
function Menu(){return/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"main-menu",children:[/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"top-bar",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"spacer"}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"rule"})]}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"content"}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"bottom-bar",children:/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"rule"})})]});}
;// CONCATENATED MODULE: ./src/dialogue.tsx
function Dialogue(){var globals=useGlobals();var dialogueSpeaker=useReactiveValue(globals.dialogueSpeaker);var dialogueText=useReactiveValue(globals.dialogueText);return/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"black-bar",children:/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"content",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("h1",{className:"title",children:dialogueSpeaker}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"gradient-rule"}),/*#__PURE__*/(0,jsx_runtime.jsx)("p",{className:"message",children:dialogueText})]})});}
;// CONCATENATED MODULE: ./src/index.tsx
function App(){var globals=useGlobals();var route=useReactiveValue(globals.route);var navigate=useNavigate();(0,react.useEffect)(function(){console.log("Navigate to route: ".concat(route));navigate(route);},[route,navigate]);return/*#__PURE__*/(0,jsx_runtime.jsxs)(Routes,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(Route,{path:"/",element:/*#__PURE__*/(0,jsx_runtime.jsx)("view",{})}),/*#__PURE__*/(0,jsx_runtime.jsx)(Route,{path:"/menu",element:/*#__PURE__*/(0,jsx_runtime.jsx)(Menu,{})}),/*#__PURE__*/(0,jsx_runtime.jsx)(Route,{path:"/dialogue",element:/*#__PURE__*/(0,jsx_runtime.jsx)(Dialogue,{})})]});}_render(/*#__PURE__*/(0,jsx_runtime.jsx)(MemoryRouter,{children:/*#__PURE__*/(0,jsx_runtime.jsx)(App,{})}));
})();
